...
ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\MISI\PycharmProjects\Ensha\frontend\build\assets\frame6")
...
canvas.create_text(
    ...
    215.0,
    anchor="nw",
    text="ID               timestamp              event_type                    status                description          resource",
    fill="#000000",
    font=("Inter", 16 * -1)
)
...
canvas.create_text(
    ...
    125.4041748046875,
    anchor="nw",
    text="Log system events, activities and user action ",
    fill="#736F7C",
    font=("Inter", 16 * -1)
)
