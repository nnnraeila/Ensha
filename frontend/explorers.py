...
ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\MISI\PycharmProjects\Ensha\frontend\build\assets\frame5")
...
canvas.create_text(
    ...
    126.0,
    anchor="nw",
    text="Browse, manage and rollback recent files",
    fill="#736F7C",
    font=("Inter", 16 * -1)
)
...
canvas.create_text(
    ...
    295.0,
    anchor="nw",
    text="file_name           timestamp             file_type                size               rollback              delete",
    fill="#000000",
    font=("Inter", 16 * -1)
)
