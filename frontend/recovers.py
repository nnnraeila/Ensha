...
ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\MISI\PycharmProjects\Ensha\frontend\build\assets\frame4")
...
canvas.create_text(
    ...
    126.0,
    anchor="nw",
    text="Recover files from previous backups and version history",
    fill="#736F7C",
    font=("Inter", 16 * -1)
)
...
canvas.create_text(
    ...
    335.0,
    anchor="nw",
    text="NAMETEXT       TIMESTAMP        TIMESTAMP        SIZETEXT         VERSIONTEXT     STATUSTEXT   ",
    fill="#000000",
    font=("Inter", 16 * -1)
)
